...
file_path_1 = 'reference.txt'  # Replace with the first actual file path
file_path_2 = 'to_compare.txt'  # Replace with the second actual file path
vertex_se2_id = 210
...
plt.scatter(vertex_se2_x1, vertex_se2_y1, color='blue', label= file_path_1+f'   File 1: VERTEX_SE2 ID {vertex_se2_id}')
for x, y in connected_vertices1:
    plt.scatter(x, y, color='lightblue')
    plt.plot([vertex_se2_x1, x], [vertex_se2_y1, y], 'b-', linewidth=1)

# Plot for the second file
plt.scatter(vertex_se2_x2, vertex_se2_y2, color='green', label=file_path_2+f'    File 2: VERTEX_SE2 ID {vertex_se2_id}')
