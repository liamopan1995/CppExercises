...
double *ptr_r1 = &r1;
double *ptr_r2 = &r2;
getCoefficients(ptr_a, ptr_b, ptr_c);
solveQuadratic(ptr_a,ptr_b,ptr_c,ptr_r1,ptr_r2);
printRoots(ptr_r1, ptr_r2);
return 0;
}
/*
...
* ---------------------------------------
* Solves a quadratic equation for the coefficients a, b, and c.
